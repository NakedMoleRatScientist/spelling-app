...
(function() {
  $(function() {
    var emptyInput, initializeSessionStorage, randomLetter, random_question, startUp, update_keyHandler, update_question, words;
    initializeSessionStorage = function() {
      if (localStorage.getItem("created_at") === null) {
        return localStorage.setItem("created_at", new Date());
      }
    };
